...
export const personal = {
  name: "nexterade",
  title: "Builder • Tinkerer • Automation Enthusiast",
  location: "Indonesia",
  heroKicker: "Builder & Automation Enthusiast",
  heroHeadline: "I build tools that automate the boring stuff.",
  heroStatement: "I design and develop modern, high-performance CLI & web experiences.",
  aboutHeading: "I build tools that feel clear, modern, and memorable.",
  aboutParagraphs: [
    "Seorang manusia yang percaya bahwa kalau sebuah pekerjaan bisa dibuat otomatis, kenapa harus dilakukan manual berkali-kali?",
    "Suka ngoprek Python, terminal, Android, automation, UI, dan project yang awalnya kecil... kemudian entah kenapa berubah menjadi project besar. 💀"
  ]
};
